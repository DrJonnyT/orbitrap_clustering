...
o3_clusters_unscaled = avg_array_clusters(cluster_labels_unscaled,df_all_merge['o3_ppbv'])
no2_clusters_unscaled = avg_array_clusters(cluster_labels_unscaled,df_all_merge['no2_ppbv'])
co_clusters_unscaled = avg_array_clusters(cluster_labels_unscaled,df_all_merge['co_ppbv'])
so2_clusters_unscaled = avg_array_clusters(cluster_labels_unscaled,df_all_merge['so2_ppbv'])

o3_clusters_minmax = avg_array_clusters(cluster_labels_minmax,df_all_merge['o3_ppbv'])
no2_clusters_minmax = avg_array_clusters(cluster_labels_minmax,df_all_merge['no2_ppbv'])
co_clusters_minmax = avg_array_clusters(cluster_labels_minmax,df_all_merge['co_ppbv'])
so2_clusters_minmax = avg_array_clusters(cluster_labels_minmax,df_all_merge['so2_ppbv'])

o3_clusters_qt = avg_array_clusters(cluster_labels_qt,df_all_merge['o3_ppbv'])
no2_clusters_qt = avg_array_clusters(cluster_labels_qt,df_all_merge['no2_ppbv'])
co_clusters_qt = avg_array_clusters(cluster_labels_qt,df_all_merge['co_ppbv'])
so2_clusters_qt = avg_array_clusters(cluster_labels_qt,df_all_merge['so2_ppbv'])

o3_clusters_signoise = avg_array_clusters(cluster_labels_signoise,df_all_merge['o3_ppbv'])
no2_clusters_signoise = avg_array_clusters(cluster_labels_signoise,df_all_merge['no2_ppbv'])
co_clusters_signoise = avg_array_clusters(cluster_labels_signoise,df_all_merge['co_ppbv'])
so2_clusters_signoise = avg_array_clusters(cluster_labels_signoise,df_all_merge['so2_ppbv'])
...
#Make all the y scales the same
co_scale_max = 1.05 * np.amax([co_clusters_unscaled.max(),co_clusters_minmax.max(),co_clusters_qt.max(),co_clusters_signoise.max()])
o3_scale_max = 1.05 * np.amax([o3_clusters_unscaled.max(),o3_clusters_minmax.max(),o3_clusters_qt.max(),o3_clusters_signoise.max()])
no2_scale_max = 1.05 * np.amax([no2_clusters_unscaled.max(),no2_clusters_minmax.max(),no2_clusters_qt.max(),no2_clusters_signoise.max()])
so2_scale_max = 1.05 * np.amax([so2_clusters_unscaled.max(),so2_clusters_minmax.max(),so2_clusters_qt.max(),so2_clusters_signoise.max()])


#Unscaled data
fig,ax = plt.subplots(2,2,figsize=(10,10))
ax = ax.ravel()
ax[0].bar(co_clusters_unscaled.index.astype(str),co_clusters_unscaled.values,color='gray')
ax[0].set_ylabel('CO (ppbv)')
ax[0].set_ylim(None,co_scale_max)
#ax[0].axhline(y=HC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[1].bar(no2_clusters_unscaled.index.astype(str),no2_clusters_unscaled.values)
ax[1].set_ylabel('NO2 (ppbv)')
ax[1].set_ylim(None,no2_scale_max)
#ax[1].axhline(y=NC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[2].bar(o3_clusters_unscaled.index.astype(str),o3_clusters_unscaled.values,color='g')
ax[2].set_ylabel('O3 (ppbv)')
ax[2].set_ylim(None,o3_scale_max)
#ax[2].axhline(y=OC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[3].bar(so2_clusters_unscaled.index.astype(str),so2_clusters_unscaled.values,color='r')
ax[3].set_ylabel('SO2 (ppbv)')
ax[3].set_ylim(None,so2_scale_max)
#ax[3].axhline(y=SC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
plt.suptitle('Unscaled data, 4 clusters')
plt.tight_layout()
plt.show()
...
fig,ax = plt.subplots(2,2,figsize=(10,10))
ax = ax.ravel()
ax[0].bar(co_clusters_minmax.index.astype(str),co_clusters_minmax.values,color='gray')
ax[0].set_ylabel('CO (ppbv)')
ax[0].set_ylim(None,co_scale_max)
#ax[0].axhline(y=HC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[1].bar(no2_clusters_minmax.index.astype(str),no2_clusters_minmax.values)
ax[1].set_ylabel('NO2 (ppbv)')
ax[1].set_ylim(None,no2_scale_max)
#ax[1].axhline(y=NC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[2].bar(o3_clusters_minmax.index.astype(str),o3_clusters_minmax.values,color='g')
ax[2].set_ylabel('O3 (ppbv)')
ax[2].set_ylim(None,o3_scale_max)
#ax[2].axhline(y=OC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[3].bar(so2_clusters_minmax.index.astype(str),so2_clusters_minmax.values,color='r')
ax[3].set_ylabel('SO2 (ppbv)')
ax[3].set_ylim(None,so2_scale_max)
#ax[3].axhline(y=SC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
plt.suptitle('MinMax data, 6 clusters')
...
fig,ax = plt.subplots(2,2,figsize=(10,10))
ax = ax.ravel()
ax[0].bar(co_clusters_qt.index.astype(str),co_clusters_qt.values,color='gray')
ax[0].set_ylabel('CO (ppbv)')
ax[0].set_ylim(None,co_scale_max)
#ax[0].axhline(y=HC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[1].bar(no2_clusters_qt.index.astype(str),no2_clusters_qt.values)
ax[1].set_ylabel('NO2 (ppbv)')
ax[1].set_ylim(None,no2_scale_max)
#ax[1].axhline(y=NC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[2].bar(o3_clusters_qt.index.astype(str),o3_clusters_qt.values,color='g')
ax[2].set_ylabel('O3 (ppbv)')
ax[2].set_ylim(None,o3_scale_max)
#ax[2].axhline(y=OC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[3].bar(so2_clusters_qt.index.astype(str),so2_clusters_qt.values,color='r')
ax[3].set_ylabel('SO2 (ppbv)')
ax[3].set_ylim(None,so2_scale_max)
#ax[3].axhline(y=SC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
plt.suptitle('QT data, 6 clusters')
...
fig,ax = plt.subplots(2,2,figsize=(10,10))
ax = ax.ravel()
ax[0].bar(co_clusters_signoise.index.astype(str),co_clusters_signoise.values,color='gray')
ax[0].set_ylabel('CO (ppbv)')
ax[0].set_ylim(None,co_scale_max)
#ax[0].axhline(y=HC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[1].bar(no2_clusters_signoise.index.astype(str),no2_clusters_signoise.values)
ax[1].set_ylabel('NO2 (ppbv)')
ax[1].set_ylim(None,no2_scale_max)
#ax[1].axhline(y=NC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[2].bar(o3_clusters_signoise.index.astype(str),o3_clusters_signoise.values,color='g')
ax[2].set_ylabel('O3 (ppbv)')
ax[2].set_ylim(None,o3_scale_max)
#ax[2].axhline(y=OC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
ax[3].bar(so2_clusters_signoise.index.astype(str),so2_clusters_signoise.values,color='r')
ax[3].set_ylabel('SO2 (ppbv)')
ax[3].set_ylim(None,so2_scale_max)
#ax[3].axhline(y=SC_all_avg, linestyle='--',color=(0, 0, 0, 0.85))
plt.suptitle('Sig/Noise data, 6 clusters')
